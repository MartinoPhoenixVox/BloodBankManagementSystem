...
namespace DTO_BBMS
{
    public class DTO_NguoiHienMau
    {
        ...
        public DTO_NguoiHienMau(int MaNHM, string HoTen, DateTime NgaySinh, string DiaChi, bool GioiTinh, string SDT, string Email)
        {
